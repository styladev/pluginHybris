...
/**
 * Provides necessary meta information about the stylaaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.7.0.3
 */
public class StylaaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(StylaaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.styla.hmc.locales";
