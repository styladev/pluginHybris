...
import com.styla.constants.StylaaddonConstants;



/**
 * This is the extension manager of the Stylaaddon extension.
 */
public class StylaaddonManager extends GeneratedStylaaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(StylaaddonManager.class.getName());
	 ...
	 */
	public static StylaaddonManager getInstance()
	{
		return (StylaaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				StylaaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public StylaaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of StylaaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of StylaaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of StylaaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
