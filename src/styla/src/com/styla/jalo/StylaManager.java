...
/**
 * This is the extension manager of the Styla extension.
 */
public class StylaManager extends GeneratedStylaManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(StylaManager.class.getName());
	 ...
	 */
	public static StylaManager getInstance()
	{
		return (StylaManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				StylaConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public StylaManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of StylaManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of StylaManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of StylaManager called, current tenant: " + getTenant().getTenantID());
		}
	}
